...
public class Ellipse implements Shape {
	...
	/*I set up an extra one with ID just in case, won't be used.*/
	public Ellipse(int x1, int y1, int x2, int y2, Color color, int ID) {
		setCorners(x1, y1, x2, y2);
		this.color = color;
		this.id = id;
	}
	...
	/*useful for knowing if an ellipse continues a point*/
	@Override
	...
	@Override
	/*move the ellipse by whatever d you set.*/
	...
	public String toString() {
		return "e," + x1+","+y1+","+x2+","+y2+","+color.getRGB()+",";
	}
}
