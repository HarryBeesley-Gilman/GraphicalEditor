 ...
 * June/1/22
 * Purpose: assemble segment class for individual use and polylines
 */
public class Segment implements Shape {
	...
	public Segment(int x1, int y1, int x2, int y2, Color color, int id) {
		this.x1 = x1; this.y1 = y1;
		this.x2 = x2; this.y2 = y2;
		this.color = color;
		this.id = id;
	...
	public String toString() {
		return "s,"+ x1 + "," + y1+","+x2+","+y2+","+color.getRGB() + ",";
	}
}
